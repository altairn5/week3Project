...
<span class="cstat-no" title="statement not covered" >    shouldCompileTo("\\{{foo}}", { foo: "phrase" }, "{{foo}}");</span>
<span class="cstat-no" title="statement not covered" >    shouldCompileTo("content \\{{foo}}", { foo: "phrase" }, "content {{foo}}");</span>
<span class="cstat-no" title="statement not covered" >    shouldCompileTo("\\\\{{foo}}", { foo: "phrase" }, "\\phrase");</span>
<span class="cstat-no" title="statement not covered" >    shouldCompileTo("content \\\\{{foo}}", { foo: "phrase" }, "content \\phrase");</span>
<span class="cstat-no" title="statement not covered" >    shouldCompileTo("\\\\ {{foo}}", { foo: "phrase" }, "\\\\ phrase");</span>
  });
&nbsp;
